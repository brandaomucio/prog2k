...
if __name__ == "__main__":
    ...
    db.connect() 
    db.create_tables([Funcionario, Maquinario, Cliente, Fornecedor, Construtora, Engenheiro, Arquiteto, Material, Equipe, Obra, Acabamento, Construtora.clientes.get_through_model(), Equipe.funcionarios.get_through_model()])

#funcionario ok
    fun1 = Funcionario.create(nome = "Carlos", salario = "4300")

#maquinario ok
    maq1 = Maquinario.create(nome_maq = "Trator", fornecedor_maq = "New Holland")
...
#ManyToMany
    ...
    print("nome maquinário: ",maq1.nome_maq,"||     fornecedor do maquinário: ",maq1.fornecedor_maq)
